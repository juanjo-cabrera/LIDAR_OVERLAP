...
from MinkLoc3Dv2_models.quantization import PolarQuantizer, CartesianQuantizer


class ModelParams:
    def __init__(self, model_params_path='/home/arvc/Juanjo/develop/LIDAR_OVERLAP/MinkLoc3Dv2_models/minkloc3dv2.txt'):
