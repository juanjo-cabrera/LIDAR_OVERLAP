...
from ml_tools.netVLAD import *

class VGG16_VLAD(nn.Module):
    def __init__(self, in_channels, out_channels, D):
        super(VGG16_VLAD, self).__init__()
        ...
        self.net_vlad = MinkNetVladWrapper(feature_size=512, cluster_size=64, output_dim=256,
                     gating=True)
