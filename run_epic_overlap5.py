...
def main():
    ...
    keyframe_manager.compute_normalization(scan_idx)
    ...
    if saved_overlap == True:
        ...
        for i in range(50, len(scan_times)):
            ...
            for gamma in gammas:
                ...
                #
                # if debug:
                    # keyframe_manager.keyframes[i].draw_pointclouds(keyframe_manager.keyframes[scan_idx], transformation_matrix)
        ...
        xys = gt_pos[:, 0:2]
        with open("metodo23_overlaps_pi_sextos", "wb") as fp:
